...
| attacker_modifier | list<modifiers> | Modifiers for the attackers in a combat.<br>See [Terrain modding#Modifiers](#modifiers). | attacker_modifier = {<br> 	hard_casualty_modifier = 0.2<br> 	retreat_losses = 0.25<br> } |
| defender_modifier | list<modifiers> | Modifiers for the defender in a combat.<br>See [Terrain modding#Modifiers](#modifiers). | defender_modifier = {<br> 	hard_casualty_modifier = 0.2<br> 	retreat_losses = 0.25<br> } |
...
| province_modifier | list<modifiers> | Modifier applied to the province.<br>See [Terrain modding#Modifiers](#modifiers). | province_modifier = {<br> 	supply_limit_mult = -0.1<br> 	travel_danger = 45<br> 	county_fertility_growth_add = 0.15<br> } |
| county_capital_modifier | list<modifiers> | Modifier applied to the province if it is the county capital.<br>See [Terrain modding#Modifiers](#modifiers). | county_capital_modifier = {<br> 	development_growth_factor = -0.05<br> } |
