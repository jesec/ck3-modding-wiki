...
| watercolorGen | [Map modding](Map_modding.md) | Broken link: [Github](https://github.com/sp-droid/myrepo/tree/main/Projects/watercolorGen) | A tool that generates a watercolour image for a realistic sea floor. Works for both Crusader Kings 3 and Imperator: Rome. |
| flowmapGen | [Map modding](Map_modding.md) | Broken link: [Github](https://github.com/sp-droid/myrepo/tree/main/Projects/flowmapGen) | A tool that generates an image for river flow, based on an input heightmap. Works for both Crusader Kings 3 and Imperator: Rome. |
